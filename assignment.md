...
# 4\. Distributed System Expectations

Candidates should explain:

- How multiple workers run safely
- How messages are not lost
- How retries are handled
- How duplicate messages are avoided or tolerated
- How output file writing is coordinated
- How the system recovers after crash
- What bottlenecks exist
- How they would monitor the system
